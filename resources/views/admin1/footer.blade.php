	...
	<script src="{{ asset('admin1/js/jquery-2.2.4.min.js') }}"></script>
	<script src="{{ asset('admin1/js/bootstrap.min.js') }}"></script>
	<script src="{{ asset('admin1/js/jquery.dataTables.min.js') }}"></script>
	<script src="{{ asset('admin1/js/dataTables.bootstrap.min.js') }}"></script>
	<script src="{{ asset('admin1/js/select2.full.min.js') }}"></script>
	<script src="{{ asset('admin1/js/jquery.inputmask.js') }}"></script>
	<script src="{{ asset('admin1/js/jquery.inputmask.date.extensions.js') }}"></script>
	<script src="{{ asset('admin1/js/jquery.inputmask.extensions.js') }}"></script>
	<script src="{{ asset('admin1/js/moment.min.js') }}"></script>
	<script src="{{ asset('admin1/js/bootstrap-datepicker.js') }}"></script>
	<script src="{{ asset('admin1/js/icheck.min.js') }}"></script>
	<script src="{{ asset('admin1/js/fastclick.js') }}"></script>
	<script src="{{ asset('admin1/js/jquery.sparkline.min.js') }}"></script>
	<script src="{{ asset('admin1/js/jquery.slimscroll.min.js') }}"></script>
	<script src="{{ asset('admin1/js/jquery.fancybox.pack.js') }}"></script>
	<script src="{{ asset('admin1/js/app.min.js') }}"></script>
	<script src="{{ asset('admin1/js/jscolor.js') }}"></script>
	<script src="{{ asset('admin1/js/on-off-switch.js') }}"></script>
	<script src="{{ asset('admin1/js/on-off-switch-onload.js') }}"></script>
	<script src="{{ asset('admin1/js/clipboard.min.js') }}"></script>
	<script src="{{ asset('admin1/js/demo.js') }}"></script>
	<script src="{{ asset('admin1/js/summernote.js') }}"></script>
