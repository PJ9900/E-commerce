    ...
    <main class="main">
        ...
        <div class="shop-area bg py-90">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="text-center mb-5">All Products</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div class="product-bottom">
                                                ...
                                                <button value="{{$item->id}}" class="addToCartFunctionality product-cart-btn" type="button" class="product-cart-btn" data-bs-placement="left" data-bs-toggle="modal" data-bs-target="#quickview" data-tooltip="tooltip" title="Add To Cart">
